...
const rows_Teams = [
  createData_Teams(
    ...
    "Canucks",
    "Canada",
    "Bo Horvat, Daniel Sedin, Roberto Luongo",
    3
  ),
  createData_Teams(
    2,
  ...
  createData_Teams(
    ...
    "Angels",
    "United States",
    "Ohtani Shohei, Mike Trout, Tyler Anderson, Hunter Renfroe",
    4
  ),
  ...
  createData_Teams(
    ...
    "Mariners",
    "United States",
    "Julio Rodriguez, Jarred Kalenic",
    2
  ),
];
...
function SearchContainer() {
  ...
  return (
    <Box bgcolor="skyblue" flex={4} p={2}>
      ...
      />
      <Button variant="contained" endIcon={<SearchIcon />}>Submit</Button>
        </Stack>
      </Container>
